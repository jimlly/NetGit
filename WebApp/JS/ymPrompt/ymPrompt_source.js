...
(function() {
	...
	var dftCfg = {
		...
		isOpenMoreWin: true     //是否允许打开多个窗口,默认允许 Add By yxg 2011-01-13
	},curCfg = {};
		...
		var winVisible = function(visible) {
			...
			if (visible === false) { //关闭
				...
				var closeFn = function() {
					...
					//是否允许打开多个窗口:如果不允许并且队列中有值则清空队列并返回 Add By yxg 2011-01-13 Begin
					if (!curCfg.isOpenMoreWin && cacheWin.length >= 1) {
					    cacheWin = [];
					    return;
					}
					//Add By yxg 2011-01-13 End
